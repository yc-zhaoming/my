...
public class ScheduleTypeView extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		textTop.setBackgroundColor(Color.parseColor("#00ccff"));
		...
		btSave.setBackgroundColor(Color.parseColor("#00ccff"));
		btSave.setText("确定");
		btSave.setHeight(47);
		btSave.setWidth(160);
		...
		btCancel.setBackgroundColor(Color.parseColor("#00ccff"));
		btCancel.setText("取消");
		btCancel.setHeight(45);
		btCancel.setWidth(170);
		...
		group.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			...
			public void onCheckedChanged(RadioGroup group, int checkedId) {
				...
				.setSingleChoiceItems(
						new String[] { cc.remind[0], cc.remind[1], cc.remind[2], cc.remind[3] }, remindID,
